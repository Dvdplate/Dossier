...
const createdAtMs = sql`(cast(unixepoch('subsecond') * 1000 as integer))`;
...
export const tasks = sqliteTable(
  "tasks",
  {
    ...
    createdAt: integer("created_at").notNull().default(createdAtMs),
...
export const devices = sqliteTable("devices", {
  id: text("id").primaryKey(), // UUID generated by add-device CLI
  nickname: text("nickname").notNull(),
  publicKeyJwk: text("public_key_jwk").notNull(), // ECDSA P-256 public key as JSON
  createdAt: integer("created_at").notNull().default(createdAtMs),
});
